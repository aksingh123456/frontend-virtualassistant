...
import bg from "../src/assets/AI1.png"
import bg3 from "../src/assets/AI3.png"
import bg4 from "../src/assets/AI4.png"
      ...
      <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center z-10">
        <form className="w-[90%] h-[700px] max-w-[600px] bg-[#00000044] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] rounded-xl px-[20px]" onSubmit={handleSignIn} autoComplete="off">
          <h1 className="text-white text-[30px] font-semibold mb-[10px]">
            Sign In to <span className="text-amber-600">Virtual-Assistant</span>
          </h1>
  ...
  <p className="text-red-500 font-semibold text-[17px]">
    *{error}
          ...
          >
            ...
            <span className="text-amber-600 text-[18px]">Sign Up</span>
          </p>
        </form>
      </div>
    </div>
